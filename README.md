...
``````
###  OUTPUT:
![OS-EX.12-IMPLEMENTATION-OF-FILE-ALLOCATION-METHODS](1.png)
### RESULT:
...
``````
### OUTPUT:
![OS-EX.12-IMPLEMENTATION-OF-FILE-ALLOCATION-METHODS](2.png)
...
```
### OUTPUT:
![OS-EX.12-IMPLEMENTATION-OF-FILE-ALLOCATION-METHODS](3.png)
